...
class AddPlayerRc extends StatefulWidget {
  List<Player> players;
  AddPlayerRc({super.key, required this.players});

  @override
  State<AddPlayerRc> createState() => _AddPlayerRcState();
}

class _AddPlayerRcState extends State<AddPlayerRc> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("Add Player Red Card"),
      ),
      body: Padding(
